    ...
    describe("adding and removing players from the game", () => {
        ...
        describe("Active Players", () => {
            ...
            it("If player already in the game is added then throw duplicate player error", () => {
                ...
                expect(()=>{service.addPlayer(game, player)}).toThrow(new DuplicateError(`Player name must be unique to the game. a player named "${player.name}" already exists`));
            });
        ...
        describe("Spectators", () => {
            ...
            it("If player already a spectator then throw duplicate player exception", () => {
                ...
                expect(()=>{service.addSpectator(game,spectator)}).toThrow(new DuplicateError(`Player name must be unique to the game. a player named "${spectator.name}" already exists`));
            });
            ...
            it("If player is in the game then throw duplicate player error", () => {
                ...
                expect(()=>{service.addSpectator(game,player)}).toThrow(new DuplicateError(`Player name must be unique to the game. a player named "${player.name}" already exists`));
